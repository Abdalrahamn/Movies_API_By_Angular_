...
export class RegisterComponent {
  constructor(private fb: FormBuilder, private _AuthService: AuthService ,private _Router:Router ,private _ToastrService:ToastrService) {}
    ...
    this._AuthService.Register(formData).subscribe({
      next: (res) => {
        ...
        if (res.ok ) {
          ...
          this._ToastrService.success('Already Registered')
      ...
      error: (ero) => {
        ...
        this._ToastrService.error(ero.error.message)
      },
    });
  }
}